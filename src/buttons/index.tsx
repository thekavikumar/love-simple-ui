...
// Button with gradient background from cyan to blue
...
// Button with gradient background from pink to orange
...
// Button with gradient border from purple to blue
export const Button5: FC<
  ButtonProps & ButtonHTMLAttributes<HTMLButtonElement>
> = ({ children, className = "", ...props }) => {
  return (
    <button
...
// Button with gradient border from pink to orange
export const Button6: FC<
  ButtonProps & ButtonHTMLAttributes<HTMLButtonElement>
> = ({ children, className = "", ...props }) => {
  return (
    <button
...
// MasterCardButton
export const MasterCardButton: FC<
  ButtonProps & ButtonHTMLAttributes<HTMLButtonElement>
> = ({ children, className = "", ...props }) => {
  return (
    <button
